...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="PostProcessing script for RealBasicVSR in Leto")
...
def main():
    ...
    aux.upload_s3(recon_vid_obj, bucket = args.output_bucket_s3, prefix = args.ouput_prefix_s3)
