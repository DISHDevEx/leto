...
def cuda_int32(intIn: int):
    """
    Convert an integer to a cupy int32 array.

    Args:
        intIn (int): The input integer.

    Returns:
        cupy.ndarray: The corresponding int32 array.
    """
...
def cuda_float32(fltIn: float):
    """
    Convert a float to a cupy float32 array.

    Args:
        fltIn (float): The input float.

    Returns:
        cupy.ndarray: The corresponding float32 array.
    """
...
def cuda_kernel(strFunction: str, strKernel: str, objVariables: typing.Dict):
    """
    Create a CUDA kernel with variable substitutions.

    Args:
        strFunction (str): The name of the CUDA function.
        strKernel (str): The kernel code with placeholders.
        objVariables (typing.Dict): Dictionary of variable substitutions.

    Returns:
        str: The key associated with the cached kernel.
    """
...
def cuda_launch(strKey: str):
    """
    Compile and launch a CUDA kernel.

    Args:
        strKey (str): The key associated with the cached kernel.

    Returns:
        cupy.cuda.Function: The compiled CUDA function.
    """
...
def softsplat(
    ...
    """
    Apply softsplatting operation to the input tensor.

    Args:
        tenIn (torch.Tensor): Input tensor.
        tenFlow (torch.Tensor): Flow tensor.
        tenMetric (torch.Tensor): Metric tensor.
        strMode (str): Operation mode.
...
class softsplat_func(torch.autograd.Function):
    """
    Autograd function for the softsplat operation.
    """
    ...
    def forward(self, tenIn, tenFlow):
        """
        Forward pass of the softsplat operation.
    ...
    def backward(self, tenOutgrad):
        """
        Backward pass of the softsplat operation.

        Args:
            tenOutgrad (torch.Tensor): Gradient of the output tensor.

        Returns:
            torch.Tensor: Gradient of the input tensor.
            torch.Tensor: Gradient of the flow tensor.
        """
